  ...
  <footer class="mt-auto pt-4 flex flex-col items-center gap-3 border-t border-stone-200/40">
    <div class="flex items-center gap-3">
      <div class="flex items-center gap-2">
        ...
        >
          <div class="absolute inset-0 rounded-full bg-orange-400/10 animate-ping group-hover:bg-orange-400/20"></div>
      ...
      <div class="w-px h-3 bg-stone-200/60 mx-1"></div>
      ...
      <a 
        ...
        title={$t('app.github')}
        class="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-stone-100 hover:bg-stone-200 text-stone-500 hover:text-stone-700 transition-all active:scale-95"
      >
        ...
        <span class="text-[10px] font-bold uppercase tracking-tight">{$t('app.github_title')}</span>
      </a>
    </div>
